	...
	<div class="btn-group btn-group-top">
		<?php if($result[0]->runcodeurl) { ?>
			<a class="btn btn-default btn-xs" href="http://rextester.com/INH64197" target="_blank"><i class="fa fa-terminal" aria-hidden="true"></i></a>
			<a class="btn btn-default btn-xs" href="<?=$result[0]->runcodeurl?>" target="_blank"><i class="fa fa-jsfiddle" aria-hidden="true"></i></a>
		<?php } else { ?>
			<a class="btn btn-default btn-xs" href="http://rextester.com/INH64197" target="_blank"><i class="fa fa-terminal" aria-hidden="true"></i></a>
		<?php }	?>
	...
	<?php if($result[0]->solution_tags) { ?>
		<br />
		<b>Solution tags: </b><?=htmlspecialchars($result[0]->solution_tags)?>
	<?php }	?>
